        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg shadow-md p-8">
          ...
          <div className="prose prose-invert max-w-none">
            <div className="space-y-6 text-gray-300">
              <div>
                <h3 className="text-2xl font-semibold text-white mb-3">Bước 1: Truy cập ứng dụng</h3>
                <p>Mở ứng dụng trên điện thoại Android của bạn.</p>
              </div>

              <div>
                <h3 className="text-2xl font-semibold text-white mb-3">Bước 2: Đăng nhập</h3>
                <p>Nhập thông tin đăng nhập để truy cập vào hệ thống.</p>
              </div>

              <div>
                <h3 className="text-2xl font-semibold text-white mb-3">Bước 3: Sử dụng AI</h3>
                <p>Sau khi đăng nhập, bạn có thể bắt đầu sử dụng các tính năng AI có sẵn.</p>
              </div>
            </div>
          </div>
